...
describe('NftContract', () => {
    ...
    beforeAll(async () => {
        code = await compile('NftContract');
    });
    ...
    beforeEach(async () => {
        ...
        nftContract = blockchain.openContract(
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await nftContract.sendIncrease(increaser.getSender(), {
                increaseBy,
                value: toNano('0.05'),
            });
            ...
            const counterAfter = await nftContract.getCounter();
